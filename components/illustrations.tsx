...
function Node({ x, y, r = 5, grad }: { x: number; y: number; r?: number; grad?: string | null }) {
...
export function IlloGovernance() {
  const id = "il-gov";
  return (
    <Frame id={id}>
      <g {...f(0.5)}>
...
export function IlloInsuranceInd() {
  const id = "il-insi";
  return (
    <Frame id={id}>
...
export function IlloOpenSource() {
  const id = "il-oss";
  return (
    <Frame id={id}>
      <g {...f(0.4)}>
...
export function IlloPrivacy() {
  ...
  return (
    <Frame id={id}>
      ...
      <Node x={124} y={254} r={4} />
    </Frame>);
}

// ── 14 Terms — document + balance ────────────────────────
export function IlloTerms() {
  const id = "il-terms";
  return (
    <Frame id={id}>
      <g {...f(0.5)}>
...
export function IlloSecurity() {
  ...
  return (
    <Frame id={id}>
      ...
      <path d="M158 76 L222 98 V162 C222 202 194 226 158 242 C122 226 94 202 94 162 V98 Z" {...f(0.35)} fillOpacity="0.12" />
...
export function IlloResponsible() {
  const id = "il-resp";
  return (
    <Frame id={id}>
