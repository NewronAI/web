  ...
  return (
    <>
      ...
      <Prose aside={<LegalAside updated="1 May 2026" items={[["governance", "Governance"], ["data", "Data & training"], ["evaluation", "Evaluation"], ["humanoversight", "Human oversight"], ["limits", "Known limits"], ["report", "Raising concerns"]]} />}>
        ...
        <p>If you believe a Newron system has behaved unfairly or harmfully, we want to know. Contact us via <a href={route("v4.html#contact")}>our contact page</a>; concerns are routed to the team responsible for the relevant system and used to improve it.</p>
      </Prose>
