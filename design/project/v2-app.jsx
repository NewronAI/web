...
const ACCENT_OPTIONS = ["#5129f3", "#3d5afe", "#6200ea", "#1a237e", "#0b0d12"];
  ...
  return (
    <>
      ...
      <TweaksPanel>
        ...
        <TweakSelect label="Surface" value={t.surface || "default"} options={["default", "paper", "mist", "sand", "lime", "ink"]} onChange={(v) => setTweak("surface", v)} />
