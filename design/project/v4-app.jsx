...
/* Newron DS: indigo primary with orange energy + deep-indigo */
const ACCENT_OPTIONS = ["#4F46E5", "#6366F1", "#3730A3", "#F97316", "#F17953"];
        ...
        <div style={{ display: "grid", gridTemplateColumns: "minmax(0, 2fr) repeat(4, minmax(0, 1fr))", gap: 32 }}>
          <div>
            ...
            <div style={{ marginTop: 18 }}>
              <span className="tag">NVIDIA PARTNERED</span>
            </div>
          </div>
          {cols.map((c) =>
          <div key={c.h}>
