/* global React */
const { PageHero, Prose, Band, renderPage } = window;
...
function Page() {
  return (<>
    ...
    <Prose aside={<LegalAside updated="1 May 2026" items={[["scope", "1. Scope"], ["collect", "2. What we collect"], ["use", "3. How we use it"], ["customer", "4. Customer data"], ["sharing", "5. Sharing"], ["retention", "6. Retention"], ["rights", "7. Your rights"], ["security", "8. Security"], ["contact", "9. Contact"]]} />}>
      ...
      <p>We apply technical and organisational measures aligned to <strong>ISO 27001</strong> and our <strong>SOC 2</strong> programme — encryption in transit, access controls, logging and least-privilege practices. For details of our security posture, see the <a href="security.html">Security</a> page.</p>

      <h2 id="contact">9. Contact us</h2>
      <p>For any privacy question or request, contact our team at <a href="v4.html#contact">our contact page</a> or write to the Data Protection point of contact at NewronAI Technologies Pvt. Ltd., Bengaluru, India. We may update this policy from time to time; material changes will be reflected by the effective date above.</p>
    </Prose>

    <Band id="more" bg="var(--bg-2)" tight style={{ borderTop: "1px solid var(--line)" }}>
      <div style={{ display: "flex", gap: 28, flexWrap: "wrap", fontSize: 14 }}>
        <a href="terms.html" style={{ color: "var(--accent)", textDecoration: "none" }}>Terms of Service →</a>
        <a href="security.html" style={{ color: "var(--accent)", textDecoration: "none" }}>Security →</a>
        <a href="responsible-ai.html" style={{ color: "var(--accent)", textDecoration: "none" }}>Responsible AI →</a>
      </div>
    </Band>
  </>);
}
