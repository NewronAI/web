/* global React */
const { PageHero, Band, Head, SplitRows, FeatureGrid, Prose, FAQ, CTABand, renderPage } = window;
  ...
  return (<>
    ...
    <Band id="certs">
      ...
      <div style={{ marginTop: 48, display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
        {[["ISO 27001", "Information security management system aligned to the standard."], ["SOC 2", "Type II programme covering security, availability and confidentiality (in progress)."], ["Data residency", "Indian data-residency commitments; training on India-hosted data."]].map(([t, d]) =>
